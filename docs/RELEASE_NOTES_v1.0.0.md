...
- **ShadowMountPlus compatible** option (off by default) — turn it on to build images
  with a >= 32 KiB block that mount cleanly under ShadowMountPlus; left off you get the
  smallest image on tiny-file games.
